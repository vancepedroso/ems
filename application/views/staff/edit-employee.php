          ...
          <div class="box box-info">
            ...
            <?php if(isset($content)): ?>
              <?php foreach($content as $cnt): ?>
                  <!-- form start -->
                  <?php echo form_open_multipart('Staff/updates');?>
                    <div class="box-body">
...
<div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <div class="col-md-6">
                  <div class="form-group">
               <label>1st Work Experience</label>
            <input type="text" name="txtemergecnyaddress" value="" class="form-control" placeholder="1st Work Experience">
                  </div>
                </div>
        ...
        <div class="col-md-6">
              <div class="form-group">
                <label>Start-End of 1st Work</label>
              ...
              <!-- /.form group -->
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
               <label>2nd Work Experience</label>
            <input type="text" name="txtemergecnyaddress" value="" class="form-control" placeholder="2nd Work Experience">
                  </div>
                </div>

                 <div class="col-md-6">
              <div class="form-group">
                <label>Start-End of 2nd Work</label>
              ...
              <!-- /.form group -->
                ...
                <div class="col-md-6">
                  <div class="form-group">
               <label>3rd Work Experience</label>
            <input type="text" name="txtemergecnyaddress" value="" class="form-control" placeholder="3rd Work Experience">
                  </div>
                </div>

 <div class="col-md-6">
              <div class="form-group">
                <label>Start-End of 3rd Work</label>
