...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>Employee Management</span>
      <!-- logo for regular state and mobile devices -->
      <span style="font-size:12.0pt" class="logo-lg">Employee Management</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php $user=$this->session->userdata('username'); echo $user;?></p>
 ...
 -->
      ...
      <li class="treeview">
      <li><a href="<?php echo base_url(); ?>manage-staff"><i class="fa fa-users"></i>Employee List</a></li>
         ...
         <li class="treeview">
      <li><a href="<?php echo base_url(); ?>tenured"><i class="fa fa-user"></i>Tenured</a></li>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
          ...
          <ul class="treeview-menu">
           ...
           <li class="treeview">
          <a href="#">
            <i class="fa fa-users"></i> <span>Dashboard Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>reminders"><i class="fa fa-circle-o"></i> Reminders</a></li>
           
          </ul>
        </li>
      <li class="treeview">
      <li><a href="<?php echo base_url(); ?>changepass"><i class="fa fa-key"></i>Change Password</a></li>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <li class="treeview">
      <li><a href="<?php echo base_url(); ?>logs"><i class="fa fa-history"></i>Logs</a></li>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <li class="treeview">
      <li><a href="<?php echo base_url(); ?>csvToMySQL"><i class="fa fa-history"></i>Import</a></li>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
