  ...
  function select_leave_byStaffID($staffid)
    {
        ...
        $this->db->select("leave_tbl.*,staff_tbl.staff_name,staff_tbl.companyemail,staff_tbl.fblink,staff_tbl.country,staff_tbl.mobile,staff_tbl.email,department_tbl.department_name");
