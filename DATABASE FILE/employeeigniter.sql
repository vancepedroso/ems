...
(8, 'markh@gmail.com', '7070707069', 2, 1),z
...
CREATE TABLE `staff_tbl` (
  ...
  `perad` varchar(150) NOT NULL,
  `fbuser` varchar(150) NOT NULL,
  `education` varchar(150) NOT NULL,
  `marital` varchar(150) NOT NULL,
  `religion` varchar(150) NOT NULL,
  `blood` varchar(150) NOT NULL,
  `alergy` varchar(150) NOT NULL,
  `med` varchar(150) NOT NULL,
  `company` varchar(150) NOT NULL,
  `position` varchar(150) NOT NULL,
  `campaign` varchar(150) NOT NULL,
  `citizenship` varchar(150) NOT NULL,
  `psbank` varchar(150) NOT NULL,
  `sss` varchar(150) NOT NULL,
  `tin` bigint(20) NOT NULL,
  `philhealth` bigint(20) NOT NULL,
  `pagibig` varchar(150) NOT NULL,
  `emergency` varchar(150) NOT NULL,
  `emergencycontact` bigint(20) NOT NULL,
  `emergecnyrelationship` varchar(150) NOT NULL,
...
INSERT INTO `staff_tbl` (`id`, `staff_name`, `gender`, `email`, `mobile`, `dob`, `doj`, `address`, `country`, `department_id`, `pic`, `added_by`, `updated_on`, `added_on`) VALUES
