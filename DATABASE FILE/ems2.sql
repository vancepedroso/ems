...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2021 at 09:29 PM
...
CREATE TABLE `staff_tbl` (
  ...
  `pic` varchar(150) NULL DEFAULT 'default-pic.jpg',
  `education` varchar(150) NULL,
  `marital` varchar(150) NULL,
  `religion` varchar(150) NULL,
  `blood` varchar(150) NULL,
  `alergy` varchar(150) NULL,
  `med` varchar(150) NULL,
  `company` varchar(150) NULL,
  `position` varchar(150) NULL,
  `campaign` varchar(150) NULL,
  `citizenship` varchar(150) NULL,
  `psbank` varchar(150) NULL,
  `sss` varchar(150) NULL,
  `tin` bigint(20) NULL,
  `philhealth` bigint(20) NULL,
  `pagibig` varchar(150) NULL,
  `emergency` varchar(150) NULL,
  `emergencycontact` bigint(20) NULL,
  `emergecnyrelationship` varchar(150) NULL,
  `emergecnyaddress` text,
...
(12, 'vance pedroso', 'Male', 'vpedroso@launchpad.com', 9097166859, '2001-01-30', '2021-07-12', 'Davao city', 'pedrosovancelief@gmail.com', 'facebook.com/admin.o8', 'Philippines', 12, 'arnie.jpg', 1, '0000-00-00', '2021-10-12 19:09:44');
